<script>
  ...
  $: if ($isFirstVideoLoaded) {
	...
	const dataPath = import.meta.env.PROD ? `https://www.${$domain}.com/static/hi/2022/${projectName}/data` : "../../src/data"
	const assetPath = import.meta.env.PROD ? `https://www.${$domain}.com/static/hi/2022/${projectName}` : "../../"
